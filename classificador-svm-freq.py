...
for index in range(0,3):
    ...
    for k in range(1,8,1):
        ...
        data = np.loadtxt(pathDict[index] + 'freq-' + str(k) + '-mer.csv', dtype=np.float64, delimiter=',')
    ...
    print('Imprimindo estatísticas para frequências de k-mers.')
    # printar a lista em ordem
    resultFile = open(pathDict[index] + 'freq-results.txt','w')
